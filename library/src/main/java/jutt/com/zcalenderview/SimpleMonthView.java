...
class SimpleMonthView extends View
{
    ...
    protected static int DEFAULT_HEIGHT = 70;
    ...
    public SimpleMonthView(Context context, TypedArray typedArray)
    {
        ...
        mCurrentDayColor  = typedArray.getColor(R.styleable.ZCalenderView_colorCurrentDayCircle, resources.getColor(R.color.current_day_background));
        mCurrentDayTextColor = typedArray.getColor(R.styleable.ZCalenderView_colorCurrentDayText, resources.getColor(R.color.normal_day));
        mMonthTextColor = typedArray.getColor(R.styleable.ZCalenderView_colorMonthName, resources.getColor(R.color.normal_month));
        mMonthDayLabelTextColor = resources.getColor(R.color.month_day_label_text);
        mDayTextColor = typedArray.getColor(R.styleable.ZCalenderView_colorDayName, resources.getColor(R.color.normal_day));
        mDayNumColor = typedArray.getColor(R.styleable.ZCalenderView_colorNormalDay, resources.getColor(R.color.normal_day));
        mPreviousDayColor = typedArray.getColor(R.styleable.ZCalenderView_colorPreviousDay, resources.getColor(R.color.normal_day));
        mSelectedDaysColor = typedArray.getColor(R.styleable.ZCalenderView_colorSelectedDayBackground, resources.getColor(R.color.selected_day_background));
        mMonthTitleBGColor = typedArray.getColor(R.styleable.ZCalenderView_colorSelectedDayText, resources.getColor(R.color.selected_day_text));
        ...
        MINI_DAY_NUMBER_TEXT_SIZE = typedArray.getDimensionPixelSize(R.styleable.ZCalenderView_textSizeDay, resources.getDimensionPixelSize(R.dimen.text_size_day));
        MONTH_LABEL_TEXT_SIZE = typedArray.getDimensionPixelSize(R.styleable.ZCalenderView_textSizeMonth, resources.getDimensionPixelSize(R.dimen.text_size_month));
        MONTH_DAY_LABEL_TEXT_SIZE = typedArray.getDimensionPixelSize(R.styleable.ZCalenderView_textSizeDayName, resources.getDimensionPixelSize(R.dimen.text_size_day_name));
        MONTH_HEADER_SIZE = typedArray.getDimensionPixelOffset(R.styleable.ZCalenderView_headerMonthHeight, resources.getDimensionPixelOffset(R.dimen.header_month_height));
        DAY_SELECTED_CIRCLE_SIZE = typedArray.getDimensionPixelSize(R.styleable.ZCalenderView_selectedDayRadius, resources.getDimensionPixelOffset(R.dimen.selected_day_radius));
        ...
        mRowHeight = ((typedArray.getDimensionPixelSize(R.styleable.ZCalenderView_calendarHeight, resources.getDimensionPixelOffset(R.dimen.calendar_height)) - MONTH_HEADER_SIZE) / 6);
	...
	private void drawMonthTitle(Canvas canvas) {
        ...
        canvas.drawText(stringBuilder.toString().toUpperCase(), x, y - 10, mMonthTitlePaint);
	}
    ...
    protected void drawDots(int x, int y, int count, Canvas canvas) {
        switch (count) {
            case 1:
                canvas.drawCircle(x, (y + EVENT_DOTS_CIRCLE_SIZE * 16 / 5) + 20, EVENT_DOTS_CIRCLE_SIZE, mEventCirclePaint);
                break;
            case 2:
                canvas.drawCircle(x - EVENT_DOTS_CIRCLE_SIZE * 8 / 5, (y + EVENT_DOTS_CIRCLE_SIZE * 16 / 5)+20, EVENT_DOTS_CIRCLE_SIZE, mEventCirclePaint);
                canvas.drawCircle(x + EVENT_DOTS_CIRCLE_SIZE * 8 / 5, (y + EVENT_DOTS_CIRCLE_SIZE * 16 / 5)+20, EVENT_DOTS_CIRCLE_SIZE, mEventCirclePaint);
                break;
            case 3:
            default:
                canvas.drawCircle(x - EVENT_DOTS_CIRCLE_SIZE * 16 / 5, (y + EVENT_DOTS_CIRCLE_SIZE * 16 / 5)+20, EVENT_DOTS_CIRCLE_SIZE, mEventCirclePaint);
                canvas.drawCircle(x + EVENT_DOTS_CIRCLE_SIZE * 16 / 5, (y + EVENT_DOTS_CIRCLE_SIZE * 16 / 5)+20, EVENT_DOTS_CIRCLE_SIZE, mEventCirclePaint);
                canvas.drawCircle(x, (y + EVENT_DOTS_CIRCLE_SIZE * 16 / 5)+20, EVENT_DOTS_CIRCLE_SIZE, mEventCirclePaint);
                break;
        }
	...
	protected void drawMonthNums(Canvas canvas) {
		...
		int day = 1;
        int line_y = (mRowHeight + MINI_DAY_NUMBER_TEXT_SIZE) / 2 - DAY_SEPARATOR_WIDTH + MONTH_HEADER_SIZE / 5 * 2;

		while (day <= mNumCells) {
			int x = paddingDay * (1 + dayOffset * 2) + mPadding;

            canvas.drawLine(x-40,line_y-2,mWidth,line_y-2,mDividerPaint);
	...
	protected void initView() {
        ...
        mEventCirclePaint = new Paint();
        mEventCirclePaint.setFakeBoldText(true);
        mEventCirclePaint.setAntiAlias(true);
        mEventCirclePaint.setColor(mMonthTextColor);
        mEventCirclePaint.setTextAlign(Align.CENTER);
        mEventCirclePaint.setStyle(Style.FILL);
        ...
        mDividerPaint.setStyle(Style.FILL);
        mDividerPaint.setColor(mWeekendsColor);
